...
class UpdateSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'prize_first_place_reveal_at' => ['nullable', 'date'],
            'prize_second_place_reveal_at' => ['nullable', 'date'],
            'prize_third_place_reveal_at' => ['nullable', 'date'],
            'delete_prize_first_place' => ['nullable', 'boolean'],
            'delete_prize_second_place' => ['nullable', 'boolean'],
            'delete_prize_third_place' => ['nullable', 'boolean'],
